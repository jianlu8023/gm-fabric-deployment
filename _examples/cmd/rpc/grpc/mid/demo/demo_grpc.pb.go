...
const (
	DemoService_Login_FullMethodName = "/demo.DemoService/Login"
)
...
type DemoServiceClient interface {
	Login(ctx context.Context, in *DemoRequest, opts ...grpc.CallOption) (*DemoResponse, error)
}
...
func (c *demoServiceClient) Login(ctx context.Context, in *DemoRequest, opts ...grpc.CallOption) (*DemoResponse, error) {
...
type DemoServiceServer interface {
	Login(context.Context, *DemoRequest) (*DemoResponse, error)
...
func (UnimplementedDemoServiceServer) Login(context.Context, *DemoRequest) (*DemoResponse, error) {
...
func _DemoService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).Login(ctx, req.(*DemoRequest))
	}
