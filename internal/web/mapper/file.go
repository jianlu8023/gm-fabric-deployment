...
// FileMapper 文件数据访问接口
//
// @description 定义文件及文件分片相关的数据访问方法，包括文件信息与分片信息的增删改查
// @interface
type FileMapper interface {
	...
	//
	// @description 根据查询条件逻辑删除未删除的分片记录
	// @param ctx context.Context 上下文
	// @param query model.FileChunk 分片查询条件
	// @return error 错误信息
	...
	//
	// @description 根据查询条件逻辑删除未删除的文件记录
	// @param ctx context.Context 上下文
	// @param query model.FileInfo 文件查询条件
	// @return error 错误信息
	...
	// ListFiles 列出文件
	//
	// @description 根据查询条件分页查询文件列表
	// @param ctx context.Context 上下文
	// @param query model.FileInfo 查询条件
	// @param pageInfo dbpage.Info[model.FileInfo] 分页参数
	// @return dbpage.Info[model.FileInfo] 分页结果
	// @return error 错误信息
	ListFiles(ctx context.Context, query model.FileInfo, pageInfo dbpage.Info[model.FileInfo]) (dbpage.Info[model.FileInfo], error)
}

// fileMapperImpl 文件数据访问层结构体
//
// @description 提供文件及文件分片相关的数据访问操作
// @struct
type fileMapperImpl struct {
	*Mapper
}

// NewFileMapper 创建一个新的FileMapper实例
//
// @description 创建并返回一个新的FileMapper实例，用于文件及分片相关的数据访问操作
// @param baseMapper *Mapper 基础Mapper
// @return FileMapper FileMapper实例
...
// QueryFileInfoExist 查询文件是否存在
//
// @description 根据文件查询条件查询文件是否存在，并集成链路追踪
// @param ctx context.Context 上下文
// @param query model.FileInfo 文件查询条件，非空字段将作为查询条件
// @return bool 文件是否存在
// @return error 错误信息
func (m *fileMapperImpl) QueryFileInfoExist(ctx context.Context, query model.FileInfo) (bool, error) {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "queryFileExist")
	defer span.End()
	if m.db == nil {
...
// @param fileInfo *model.FileInfo 文件信息
// @return error 错误信息
func (m *fileMapperImpl) CreateFileInfo(ctx context.Context, fileInfo *model.FileInfo) error {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "createFileInfo")
	defer span.End()
	if m.db == nil {
		span.RecordError(datasource.ErrNoDataSourceConn)
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
...
// GetFileInfoOneByQuery 根据查询条件获取单条文件信息
//
// @description 根据查询条件查询单条文件信息，并集成链路追踪
// @param ctx context.Context 上下文
// @param query model.FileInfo 查询条件
// @return *model.FileInfo 文件信息
// @return error 错误信息
func (m *fileMapperImpl) GetFileInfoOneByQuery(ctx context.Context, query model.FileInfo) (*model.FileInfo, error) {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "getOneByQuery")
	defer span.End()
	if m.db == nil {
		span.RecordError(datasource.ErrNoDataSourceConn)
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
...
//
// @description 根据自增ID查询文件信息，文件不存在时返回datasource.ErrNotExists
// @param autoUid int 自增ID
// @return *model.FileInfo 文件信息
// @return error 错误信息
func (m *fileMapperImpl) GetFileInfoByID(autoUid int) (*model.FileInfo, error) {
	if m.db == nil {
		return nil, datasource.ErrNoDataSourceConn
	}
...
//
// @description 根据上传ID查询文件信息，文件不存在时返回datasource.ErrNotExists
// @param uploadID string 上传ID
// @return *model.FileInfo 文件信息
// @return error 错误信息
func (m *fileMapperImpl) GetFileInfoByUploadID(uploadID string) (*model.FileInfo, error) {
	if m.db == nil {
		return nil, datasource.ErrNoDataSourceConn
	}
...
// @param fileInfo *model.FileInfo 文件信息
// @return error 错误信息
func (m *fileMapperImpl) UpdateFileInfo(ctx context.Context, fileInfo *model.FileInfo) error {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "updateFileInfo")
	defer span.End()
	if m.db == nil {
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
		span.RecordError(datasource.ErrNoDataSourceConn)
...
// @param fileChunk *model.FileChunk 分片信息
// @return error 错误信息
func (m *fileMapperImpl) CreateFileChunk(ctx context.Context, fileChunk *model.FileChunk) error {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "createFileChunk")
	defer span.End()
...
// CheckFileChunkExists 检查分片是否已存在
//
// @description 根据查询条件检查文件分片是否已存在，并集成链路追踪
// @param ctx context.Context 上下文
// @param query model.FileChunk 分片查询条件
// @return bool 分片是否存在
// @return error 错误信息
func (m *fileMapperImpl) CheckFileChunkExists(ctx context.Context, query model.FileChunk) (bool, error) {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "checkChunkExists")
	defer span.End()
	if m.db == nil {
		span.RecordError(datasource.ErrNoDataSourceConn)
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
...
// @param fileChunk *model.FileChunk 分片信息
// @return error 错误信息
func (m *fileMapperImpl) UpdateFileChunk(ctx context.Context, fileChunk *model.FileChunk) error {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "updateFileChunk")
	defer span.End()
	if m.db == nil {
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
		span.RecordError(datasource.ErrNoDataSourceConn)
...
// GetUploadedChunkCount 获取已上传分片数
//
// @description 根据上传ID获取已上传且未删除的分片数量，并集成链路追踪
// @param ctx context.Context 上下文
// @param uploadId string 上传ID
// @return float64 已上传分片数
// @return error 错误信息
func (m *fileMapperImpl) GetUploadedChunkCount(ctx context.Context, uploadId string) (float64, error) {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "getUploadedChunkCount")
	defer span.End()
	if m.db == nil {
		span.RecordError(datasource.ErrNoDataSourceConn)
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
...
// GetFileChunks 获取所有分片信息
//
// @description 根据查询条件获取所有未删除的分片信息，按分片索引升序排序，并集成链路追踪
// @param ctx context.Context 上下文
// @param query model.FileChunk 分片查询条件
// @return []model.FileChunk 分片列表
// @return error 错误信息
func (m *fileMapperImpl) GetFileChunks(ctx context.Context, query model.FileChunk) ([]model.FileChunk, error) {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "getFileChunks")
	defer span.End()
	if m.db == nil {
		span.RecordError(datasource.ErrNoDataSourceConn)
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
...
// GetUploadedFileChunkIndexes 获取已上传分片索引
//
// @description 根据查询条件获取已上传且未删除的分片索引列表，并集成链路追踪
// @param ctx context.Context 上下文
// @param query model.FileChunk 分片查询条件
// @return []int 分片索引列表
// @return error 错误信息
func (m *fileMapperImpl) GetUploadedFileChunkIndexes(ctx context.Context, query model.FileChunk) ([]int, error) {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "getUploadedFileChunkIndexes")
	defer span.End()
	if m.db == nil {
		span.RecordError(datasource.ErrNoDataSourceConn)
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
...
//
// @description 根据文件ID查询最后分片的上传时间
// @param fileID int 文件ID
// @return time.Time 最后分片上传时间
// @return error 错误信息
func (m *fileMapperImpl) GetLastChunkUploadTime(fileID int) (time.Time, error) {
	if m.db == nil {
...
// ListFiles 列出文件
//
// @description 根据查询条件分页查询文件列表，并集成链路追踪
// @param ctx context.Context 上下文
// @param query model.FileInfo 查询条件
// @param pageInfo dbpage.Info[model.FileInfo] 分页参数
// @return dbpage.Info[model.FileInfo] 分页结果
// @return error 错误信息
func (m *fileMapperImpl) ListFiles(ctx context.Context, query model.FileInfo, pageInfo dbpage.Info[model.FileInfo]) (dbpage.Info[model.FileInfo], error) {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "listFiles")
	defer span.End()
	if m.db == nil {
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
		span.RecordError(datasource.ErrNoDataSourceConn)
...
// @param query model.FileInfo 文件查询条件
// @return error 错误信息
func (m *fileMapperImpl) DeleteFileInfo(ctx context.Context, query model.FileInfo) error {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "deleteFileInfo")
	defer span.End()
	if m.db == nil {
		span.RecordError(datasource.ErrNoDataSourceConn)
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
...
// DeleteFileChunks 删除分片信息
//
// @description 根据查询条件逻辑删除未删除的分片记录，并集成链路追踪
// @param ctx context.Context 上下文
// @param query model.FileChunk 分片查询条件
// @return error 错误信息
func (m *fileMapperImpl) DeleteFileChunks(ctx context.Context, query model.FileChunk) error {
	_, span := tracer.StartSpan(ctx, "fileMapperImpl", "deleteFileChunks")
	defer span.End()
	if m.db == nil {
		span.SetStatus(codes.Error, datasource.ErrNoDataSourceConn.Error())
		span.RecordError(datasource.ErrNoDataSourceConn)
