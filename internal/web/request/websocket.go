...
type WSConnectRequest struct {
	NodeID string `json:"node_id,omitempty" yaml:"node_id,omitempty" form:"nodeId" binding:"required"` // NodeID 节点ID (必需)
}
...
type WSMessageRequest struct {
	Message string `json:"message,omitempty" yaml:"message,omitempty" form:"message" binding:"required"` // Message 消息内容 (必需)
	NodeID  string `json:"node_id,omitempty" yaml:"node_id,omitempty" form:"nodeId" binding:"-"`         // NodeID 目标节点ID (可选)
}
