...
// @struct
// @property ImageName string 镜像名称（必填）
// @property PeerId string 节点ID（必填）
type DockerImagePullRequest struct {
	ImageName string `json:"image_name,omitempty" yaml:"image_name,omitempty" form:"imageName" binding:"required"` // 镜像名称
	PeerId    string `json:"peer_id,omitempty" yaml:"peer_id,omitempty" form:"peerId" binding:"required"`          // 节点ID
	Platform  string `json:"platform,omitempty" yaml:"platform,omitempty" form:"platform" binding:"-"`             // 平台
}
