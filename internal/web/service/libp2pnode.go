...
// Libp2pNodeService 节点服务接口
//
// @description 定义节点服务需要实现的方法
// @interface
type Libp2pNodeService interface {
...
// libp2pNodeServiceImpl 节点服务结构体
//
// @description 实现NodeServiceInterface接口，处理节点相关业务逻辑
// @struct
type libp2pNodeServiceImpl struct {
...
// @param ctx *gin.Context Gin上下文
// @param req *request.Libp2pNodeListRequest 节点列表请求参数
func (s *libp2pNodeServiceImpl) Libp2pNodeList(ctx *gin.Context, req *request.Libp2pNodeListRequest) {
	_, span := tracer.StartSpan(ctx.Request.Context(), "libp2pNodeServiceImpl", "libp2pNodeList",
...
func (s *libp2pNodeServiceImpl) Libp2pNodeMyself(ctx *gin.Context, req *request.Libp2pNodeMyselfRequest) {
	_, span := tracer.StartSpan(ctx.Request.Context(), "libp2pNodeServiceImpl", "libp2pNodeMyself",
		attribute.String("requestParam", req.String()),
	)
	defer span.End()
